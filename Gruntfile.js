/*!
 * Ant Strap's Gruntfile (based on Bootstrap)
 * http://websemantics.github.io/ant-strap
 * http://getbootstrap.com
 * Copyright 2013-2016 The Bootstrap Authors
 * Copyright 2013-2016 Twitter, Inc.
 * Copyright 2016 Web Semantics, Inc.
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    babel: {
      dev: {
        ...
        files: {
          'js/dist/custom.js'      : 'js/src/custom.js'
        }
      },
      dist: {
        options: {
    ...
    'saucelabs-qunit': {
      all: {
        options: {
          ...
          browsers: grunt.file.readYAML('node_modules/bootstrap/grunt/sauce_browsers.yml')
        }
      }
    },
    ...
    exec: {
      ...
      'upload-preview': {
        command: './node_modules/bootstrap/grunt/upload-preview.sh'
      }
    },
  ...
  (function (sassCompilerName) {
    require('./node_modules/bootstrap/grunt/bs-sass-compile/' + sassCompilerName + '.js')(grunt);
